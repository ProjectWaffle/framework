...
import framework.core.domain.model.Auditable;
...
import framework.core.domain.repository.AuditlogRepository;
...
class DefaultAuditlogService implements AuditlogService {
    ...
    @Inject
    protected DefaultAuditlogService(AuditlogRepository auditlogRepository) {
    ...
    public void saveOrUpdate(BaseEntity entity, EventType type) {
        ...
        this.auditlogRepository.saveOrUpdate(auditlog);
    }
